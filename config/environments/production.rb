Rails.application.configure do
  ...
  config.action_controller.asset_host = 'www.InnovationQuotientTest.com'
  ...
  config.action_mailer.default_url_options =
    { host: 'innovationquotienttest.com' }
  # ActionMailer Config
  ...
  config.action_mailer.smtp_settings = {
    address: 'localhost',
    port: 587,
    domain: 'innovationquotienttest.com',
    user_name: 'results@innovationquotienttest.com',
    password: 'results',
    authentication: :login,
    openssl_verify_mode: 'none'
  }
  config.action_mailer.asset_host = 'http://www.InnovationQuotientTest.com'
